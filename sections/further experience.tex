...
\innerlist{
	\entry{Worked closely with industry experts to create a value proposition for systems engineering.}
 	\entry{Gained experience within a large company including teamwork and research skills.}
	\entry{Became familiar with presenting to large groups in a concise and efficent manner.}
}
